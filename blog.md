...
{% if post.featured %}
  <div class="post post-web" >
    ...
    <h1 class="post-title post-title-web" style="margin-bottom: 0rem;"><a href="{{ post.url }}">{{ post.title }}</a><br><div class=post-tittle-date-web>{{ page.date | date_to_string }}</div></h1>
